...
p = Producer({
    ...
    'sasl.username': 'LOHCBT53XSK62LX5',
    'sasl.password': 'AEMCfN95fGht/kXYntT6K1CfogSwAVV9uh4cigaBFA5ue3frTl+Zxl00/3J9f6t6',
    'error_cb': error_cb,
})
...
for n in range(0, 10):
    ...
    p.produce('test-topic', value='python test value nr {}'.format(n),
              callback=acked)
